...
export class DBStore {
  ...
  private getSeedData(): DatabaseSchema {
    ...
    const classes: ClassGroup[] = [
      ...
      { id: 'c4', schoolId: 'gps-amb-003', className: 'Grade 3', section: '', teacherId: 'u6_amb' },
      ...
      // ---- gps-amb-003 / Meena Kumari — Grade-only roster (no sections) ----
      // MVP scoped the Teacher dropdown to Grade instead of Class+Section.
      // Section is stored as an empty string for backwards-compat with the
      // ClassGroup type shape, and so the existing `activeClass.section`
      // reads in the UI stay safe (filter combines classGroup + section).
      { id: 'c21', schoolId: 'gps-amb-003', className: 'Grade 1', section: '', teacherId: 'u6_amb' },
      { id: 'c22', schoolId: 'gps-amb-003', className: 'Grade 2', section: '', teacherId: 'u6_amb' },
      { id: 'c23', schoolId: 'gps-amb-003', className: 'Grade 4', section: '', teacherId: 'u6_amb' }
    ];
    ...
    const students: Student[] = [
      ...
      // ---- gps-amb-003 / Meena Kumari — Grade 1 roster (4 mock students) ----
      {
        id: 's_amb_g1_1',
        name: 'Aarav Khanna',
        age: 6,
      ...
      },
      {
        ...
        currentLevel: 1,
        targetLevel: 2,
        aadharMasked: 'XXXX-XXXX-2104',
        levelHistory: [],
        streak: 0
      },
      // ---- gps-amb-003 / Meena Kumari — Grade 2 roster (4 mock students) ----
      {
        id: 's_amb_g2_1',
        name: 'Vihaan Kohli',
        age: 7,
      ...
      },
      {
        ...
        currentLevel: 2,
        targetLevel: 3,
        aadharMasked: 'XXXX-XXXX-2204',
        levelHistory: [],
        streak: 0
      },
      // ---- gps-amb-003 / Meena Kumari — Grade 4 roster (4 mock students) ----
      {
        id: 's_amb_g4_1',
        name: 'Aarush Sharma',
        age: 10,
